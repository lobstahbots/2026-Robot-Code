...
public class FieldConstants {
    ...
    public static class Tower {
        ...
        public static final Translation2d leftUpright = new Translation2d(frontFaceX,
                (aprilTagLayout.getTagPose(31).get().getY()) + innerOpeningWidth / 2
        ...
        public static final Translation2d oppLeftUpright = new Translation2d(fieldLength - frontFaceX,
                (aprilTagLayout.getTagPose(15).get().getY()) + innerOpeningWidth / 2
                        + Units.inchesToMeters(0.75));
    ...
    public static final Translation2d FIELD_CENTER = new Translation2d(fieldLength / 2.0, fieldWidth / 2.0);
}